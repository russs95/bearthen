...
function init() {
    ...
    db.transaction(function(tx) {
        ...
        var prefCols = [
            "ALTER TABLE books_tb ADD COLUMN reader_fontsize   INTEGER DEFAULT 135",
...
function updateBookMeta(id, title, author, language) {
    var db = _db()
    db.transaction(function(tx) {
    ...
    console.log("Library.updateBookMeta:", id, title, "|", author, "|", language)
}
